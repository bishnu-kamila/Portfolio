...
const Projects = () => {
  ...
  return (
    <>
      <div className="px-4 lg:px-16 mt-20">
        ...
        <div className="flex flex-col lg:flex-row border-green-700 mt-10">
          {/* Text Content */}
          <div className="text-white w-[700px] lg:ml-16"> 
  <h1
    data-aos="zoom-out"
  ...
  <p
    data-aos="fade-right"
    className="text-white mt-6 text-lg lg:text-xl max-w-[650px]"
  >
...
<div className="w-full lg:w-1/3 flex justify-center lg:justify-start mt-8 lg:mt-0">
  <div
    ...
    className="w-[650px] flex justify-center"
  >
    <img
    ...
    />
        ...
        <div
          data-aos="fade-left"
          className="flex justify-center object-cover lg:justify-start mt-12 text-2xl font-bold"
        >
